 ...
 */
export declare const goify: <T, E = Error>(operation: () => Promise<T> | T) => Promise<GoifyResult<T, E>>;
/**
 ...
 * If the operation fails, the first element is `null` and the second is an `Error` object.
 */
export declare const goifySync: <T, E = Error>(syncOperation: () => T) => GoifyResult<T, E>;
